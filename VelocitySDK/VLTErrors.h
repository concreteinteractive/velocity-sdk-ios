...
enum : NSInteger {
    ...
    VLTClientNoRecordedMotionError  = 1006, // There's no recorded motion data
    VLTWsApiQueueIsFullError        = 1007, // An error, which occurs when websocket API queue reach its limit
    VLTWsApiClientDisconnectedError = 1008, // Websockets api error
    VLTWsApiClientAlreadyOpenError  = 1009, // Websockets api error
};
